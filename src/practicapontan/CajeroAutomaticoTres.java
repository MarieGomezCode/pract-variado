...
public class CajeroAutomaticoTres {
        ...
        switch (opcion) {
            ...
            case "2":
                ...
                if (monto <= saldo) {
                    ...
                    System.out.println("Se han retirado $" + monto + " de su cuenta. y ha quedado esto de saldo"+ saldo);
                } else {
...
class Transaccion {
    ...
    public String toString() {
        return "Transacción: " + tipo + ", monto: $" + monto + ", fecha: " + fecha;
    }
}
